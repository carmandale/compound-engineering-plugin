...
- `specs/*/` — Spec directories created by `/workflows:plan`. These contain spec.md, plan.md, tasks.md, and research.md. They are living documents that track implementation progress.
